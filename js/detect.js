var detect = {
	...
	lang: function () {
		...
		var language = 'Undetectable';
		for (var lindex = 0; lindex < navigator.languages.length; lindex++) {
			var l = navigator.languages[lindex];
			if(isoLangs.hasOwnProperty(l)){
				language = isoLangs[l].name;
			}
		}
	...
	activexCheck: function(){
		...
		if(typeof(window.ActiveXObject)=="undefined"){
		    activexStatus = 'Disable';
		}else {
		    activexStatus = 'Enable';
		}
		return activexStatus;
	},
	iframCheck: function(){
		var iframStatus = 'Enable';
		return iframStatus;
	}
